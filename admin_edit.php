...
if ($role != 'super') {
  $superior = $con->query("SELECT * from `admin` WHERE `admin`.`id`=" . $data['parent'])->fetch_assoc();
  $superior_all = $con->query("SELECT * from `admin` WHERE `admin`.`role`='" . $superior['role'] . "'");
  var_dump($superior['role']);
}
                        ...
                        <tr>
                          ...
                          <td>                   
                            <div class="form-group">
                              <label for="exampleInputEmail1">Select Superior </label>
                              <select name="parent" id="product" class="form-control">
                                <?php while ($spr = $superior_all->fetch_assoc()) { ?>
                                  <option value="<?php echo ($spr['id']) ?>" <?php if ($spr['id'] == $data['parent']) { echo 'selected'; } ?>> <?php echo ($spr['name']) ?> </option>
                                <?php  } ?>
                              </select>
                            </div>
                            <!-- <input type="text" name="parent" value="<?php echo ($superior['id']) ?>" class="form-control">
                            <input type="text" name="parent" value="<?php echo ($superior['name']) ?>" class="form-control"> -->
                          </td>
                        </tr>
                        <?php  } ?>
                        <tr>
