            ...
            <div class="col-lg-12">
              ...
              <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                  ...
                  <form action="update_mrk_invoice.php?invoice_id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-6">
                          ...
                          <div class="form-group ">
                            ...
                            <select name="dealID" class="form-control">
                          ...
                          <table class="table table-bordered ">
                            ...
                            <tbody id="pd">
                              ...
                              while ($data = $qr->fetch_assoc()) {
                                ...
                                $net_payable = $data['payable'];
                                $dk = $con->query('SELECT * from products where id =' . $data['product_id'])->fetch_array();
                              ?>
                                <tr id="rem_<?php echo $i ?>">
                                  <td><?php echo $dk['name'] ?></td>
                                  <td>
                                    <input type="text" name="price[]" class="form-control" id="m_<?php echo $i ?>" readonly value="<?php echo $data['price'] ?>">
                                    <input type="hidden" name="proID[]" class="form-control" id="pk_<?php echo $i ?>" readonly value="<?php echo $data['product_id'] ?>">
                                  </td>
                                  <td>
                                    <input type="text" class="form-control" name="qID[]" id="q_<?php echo $i ?>" onkeyup="payable(<?php echo $i ?>)" value="<?php echo $data['quantity'] ?>">
                                  </td>
                                  <td>
                                    <input type="text" class="form-control" id="t_<?php echo $i ?>" name="tot[]" readonly value="<?php echo $total ?>">
                                  </td>
                                  <td>
                                    <input type="text" class="form-control" name="vat[]" id="tx_<?php echo $i ?>" value="<?php echo $data['vat'] ?>" onkeyup="payable(<?php echo $i ?>)">
                                  </td>
                                  <td><input type="text" id="p_<?php echo $i ?>" name="stotal[]" class="total form-control" readonly value="<?php echo $data['total'] ?>"></td>

                                  <td>
                                    <button style="font-size:" id="r_<?php echo $i ?>" onclick="r_(<?php echo $i ?>)" value="" class="btn btn-danger btn-xs">
                            ...
                            <tr>
                              ...
                              <td id="gt" style="font-weight:bold"><?php echo $gtl  ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td>
                                <input type="text" id="net" class="form-control" name="pable" readonly value="<?php echo $net_payable ?>" style="font-weight:bold; font-size:20px;">
                              </td>
                            </tr>
                            <tr>
      ...
      $('#product').change(function() {
        ...
        $.getJSON('fetch_data.php?id=' + id, function(data) {
          ...
          let ht = `<tr  id="rem_${i}">
                      <td> ${data.name}</td>
                      <td >
                        <input type="text" class="form-control" id="m_${i}" name="price[]" readonly value="${data.dealer_price}" >
                        <input type="hidden" class="form-control" id="pk_${i}" name="proID[]" readonly value="${data.id}" >
                      </td>
